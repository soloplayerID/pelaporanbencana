                ...
                <div class="block">
                    ...
                    <form action="<?php echo site_url('profil/edit_proses/'.$profil['nik']) ?>" method="post" class="form-horizontal form-bordered">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="tempat_lahir" class="form-control" value="<?php echo $profil['tempat_lahir'] ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input id="example-datepicker3" type="text" name="tanggal_lahir" class="form-control input-datepicker"  placeholder="Tanggal/Bulan/Tahun" data-date-format="dd-mm-yyyy" value="<?php echo $profil['tanggal_lahir'] ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <?php foreach($agama as $row): ?>
                                    <option value="<?php echo $row->id_agama ?>" <?php if($row->id_agama == $profil['id_agama']){echo "selected";} ?>><?php echo $row->nama_agama ?></option>
                                <?php endforeach; ?>
                                </select>
