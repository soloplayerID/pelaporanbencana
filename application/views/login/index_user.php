...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>LOGIN USER SIPENA BPBD KOTA BEKASI</title>
    ...
    <body>
        <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
            <img src="<?=base_url()?>logo_bpbd.png" style="height:190px; width:190px;" alt="">
                </h1>
        <!-- Login Container -->
        <div id="login-container">
            <!-- Login Header -->
            <br><h1 class="h2 text-light text-center push-top-bottom animation-slideDown"></br>
                <strong><br>Selamat Datang di <br>Aplikasi Pelaporan Bencana</br> BPBD Kota Bekasi</strong>                
                 </h1>
            <!-- END Login Header -->
            ...
            <footer class="text-muted text-center animation-pullUp">
                <small>
                    ...
                    <span>2020</span> &copy; <a href="https://bpbd.bekasikota.go.id/" target="_blank">BPBD Kota Bekasi</a>
                </small>
            </footer>
            <!-- END Footer -->
        </div>
